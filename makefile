...
LIB_SRCS := buffered_reader.c c_source_data_functions.c c_source_reader.c hashmap.c  read_from_line.c  reflection.c  scan_command_line.c  utile.c dynamic_source.c
